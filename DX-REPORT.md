...
4. **Trigger API creativity** — This was our "wow" integration. Instead of market-ordering into prediction positions, we set limit entries: "buy YES on this market only if price drops to $X." This gives the vault better entry prices and showcases creative Jupiter API usage.
...
We built Spectra Vaults primarily with **Cursor IDE + Claude** (claude-4-sonnet, claude-4-opus):
...
*Report authored for the Jupiter Developer Platform bounty at Colosseum Hackathon.*
